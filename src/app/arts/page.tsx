        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-4 mb-8">
              <service.icon className="h-8 w-8 text-grimoire-gold shrink-0 mt-1" />
              <div>
            ...
            <div className="max-w-3xl space-y-4">
              {service.body.map((paragraph, j) => (
                <p
                  key={j}
                  className="font-body text-base leading-relaxed text-grimoire-text"
                >
                  {paragraph}
                </p>
              ))}
          ...
          <div className="relative ml-4 mt-12 border-l border-grimoire-gold/30 pl-10 md:ml-8 md:pl-14 space-y-16">
            {processSteps.map((step) => (
              <div key={step.number} className="relative">
                ...
                <p className="mt-2 max-w-lg font-body text-base leading-relaxed text-grimoire-text/80">
                  {step.body}
                </p>
              </div>
            ))}

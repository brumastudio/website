...
export default async function ProspectOfferingsPage({ params }: Props) {
        ...
        <div className="mx-auto max-w-6xl">
          <StaggerContainer className="grid gap-8 md:grid-cols-3 items-stretch" stagger={0.1}>
            {tiers.map((tier, idx) => {
              ...
              const price = tierField(tier, "price", locale);
              ...
              return (
                ...
                >
                  ...
                  {/* Price */}
                  {price && (
                    <p className="mt-6 font-display text-xl text-grimoire-gold-light tracking-wide">
                      {price}
                    </p>
                  )}
